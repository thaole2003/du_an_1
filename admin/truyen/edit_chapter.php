...
<form action="" method="POST" enctype="multipart/form-data">
    <div class="panel" style="display: block;">
        ...
        <input class="m" value="<?= $load_one['noi_dung'] ?>" placeholder="Nhập nội dung tập truyện" name="noi_dung" />
        ...
        <br>
        <?php $xoa_chapter = "index.php?act=xoa_chapter&id_chapter=" . $load_one['id_ch'] ."&id=".$id ."&number_chapter=".$id_chapter?>
